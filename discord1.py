...
image2_path = 'cs-aor11-nova-obavestenja.png'
...
for url in WEBHOOK_URL:
    ...
    embed.set_image(url="attachment://cs-aor11-nova-obavestenja.png")
    file = File(image2_path, name="cs-aor11-nova-obavestenja.png")
